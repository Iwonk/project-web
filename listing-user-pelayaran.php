		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
                    ...
                    <?php
							$query = 
							"SELECT dp.id_detail, k.nama_kapal, p1.pelabuhan1, p2.pelabuhan2, dp.jadwal, dp.harga FROM detail_pelayaran dp, pelayaran p, kapal k, rute_kapal rk, pelabuhan1 p1, pelabuhan2 p2
										...
										<div class='row'>
											<div class='col-lg-8'>
												<div class='room_content'>
													<div class='room_title'>".$row['nama_kapal']."</div>
													<div class='room_price'>".$row['pelabuhan1']." - ".$row['pelabuhan2']."</div>
											...
											<div class='col-lg-4 text-lg-right'>
												<div class='room_button'>
													<div class='button book_button trans_200'><a href='project/process/actionBookingPelayaran.php?id_detail=".$row['id_detail']."'>book<span></span><span></span><span></span></a></div>
												</div>
											</div>
										</div>	
									</div>
