				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="index.php"><img src="user-index/images/logo.png" alt="">tiket travel</a></div>
                        </div>
                    </div>
				</div>
			</div>	
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="single_listing">
							<?php
							$query = 
							"SELECT k.nama_kapal, p1.pelabuhan1, p2.pelabuhan2, dp.jadwal, dp.harga FROM detail_pelayaran dp, pelayaran p, kapal k, rute_kapal rk, pelabuhan1 p1, pelabuhan2 p2
