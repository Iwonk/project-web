    ...
    <div class="page-container">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="#" aria-expanded="true">Pesawat</a>
                                        <ul class="collapse">
                                            <li class="active"><a href="../display/displayMaskapai.php">Maskapai</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">Tambah Data Maskapai</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionAddMaskapai.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Maskapai</label>
                                <div class="col-md-9">
                                    <input type="number" name="id_maskapai" id="id_maskapai" class="form-control" placeholder="Kode Maskapai" required>
                                </div>
                            </div>
                            <div class="form-group row">
