    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">Tambah Data Penerbangan</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionAddPenerbangan.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Penerbangan</label>
                                <div class="col-md-9">
                                    <input type="number" name="id_penerbangan" id="id_penerbangan" class="form-control" placeholder="Kode Penerbangan" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <?php
                                        ...
                                        if (mysqli_num_rows($result) > 0){
                                            ...
                                            {
                                                echo "
                                                <option value='".$row['id_maskapai']."'>".$row['nama_maskapai']."</option>  
                                                ";
                                            }
                                        }
                                        ?>
