    ...
    <div class="page-container">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="#" aria-expanded="true">Pesawat</a>
                                        <ul class="collapse">
                                            ...
                                            <li class="active"><a href="../display/displayData.php">Data</a></li>
                                        </ul>
                                    </li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">Tambah Data</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionAddData.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">ID</label>
                                <div class="col-md-9">
                                    <input type="number" name="id_detail" id="id_detail" class="form-control" placeholder="ID Detail" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Penerbangan</label>
                                <div class="col-md-9">
                                    <select name="id_penerbangan" class="form-control">
                            
                                    <?php
                                        $query = 
                                        "select p.id_penerbangan,m.nama_maskapai,r.nama_rute from penerbangan p,maskapai m,rute r
                                        where p.id_maskapai = m.id_maskapai AND
                                        ...
                                        if (mysqli_num_rows($result) > 0){
                                            while($row = mysqli_fetch_assoc($result)) {
                                                echo "
                                                <option value='".$row['id_penerbangan']."'>".$row['nama_maskapai']." --  (".$row['nama_rute'].")</option>  
                                                ";
                                            }
                                        }
                                        ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="harga" id="harga" class="form-control" placeholder="Biaya" required>
                                </div>
                            </div>
                            <div class="form-group row mt-5">
                                <div class="col-md-4">
                                    <a name="backBtn" id="backBtn" class="btn btn-dark btn-block" href="../display/displayData.php" role="button">Kembali</a>
                                </div>
                                <div class="col-md-4">
