...
$query = "SELECT * FROM detail_penerbangan WHERE id_detail = $id_detail";
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-8">
                        <form action="../process/actionEditData.php" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select name="id_penerbangan" class="form-control" disabled>
                                    ...
                                    <?php
                                        ...
                                        if (mysqli_num_rows($result) > 0){
                                            while($row = mysqli_fetch_assoc($result)) {
                                                if($item["id_penerbangan"] === $row["id_penerbangan"]) {
                                                    $coba = 'selected';
                                                }
                                                else {
                                                    $coba = '';
                                                ...
                                                echo "
                                                <option value='".$row['id_penerbangan']."' ".$coba.">".$row['nama_maskapai']." --  (".$row['nama_rute'].")</option>  
                                                ";
                                            }
                                        }
                                        ?>
