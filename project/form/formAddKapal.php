    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">Tambah Data Kapal</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionAddKapal.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kode Kapal</label>
                                <div class="col-md-9">
                                    <input type="number" name="id_kapal" id="id_kapal" class="form-control" placeholder="Kode Kapal" required>
                                </div>
                            </div>
                            <div class="form-group row">
