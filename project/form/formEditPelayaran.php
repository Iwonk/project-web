...
$query = "SELECT * FROM pelayaran WHERE id_pelayaran = $id_pelayaran";
    ...
    <div class="page-container">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="#" aria-expanded="true">Kapal</a>
                                        <ul class="collapse">
                                            ...
                                            <li class="active"><a href="../display/displayPelayaran.php">Pelayaran</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">Edit Data Pelayaran</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionEditPelayaran.php" method="POST">

                            <input type="hidden" name="id_pelayaran" value="<?php echo $item["id_pelayaran"] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT * FROM kapal WHERE deleted=0";
                                        $result = mysqli_query($con, $query);
                                        $coba = '';

                                        if (mysqli_num_rows($result) > 0) {
                                            while($row = mysqli_fetch_assoc($result)) {
                                                if($item["id_kapal"] === $row["id_kapal"]) {
                                                    $coba = 'selected';
                                                }
                                                else {
                                                    $coba = '';
                                                ...
                                                echo "
                                                <option value='".$row['id_kapal']."' ".$coba.">".$row['nama_kapal']."</option>  
                                                ";
                                            }
                                        }
                                        ?>
                            ...
                            <div class="form-group row">
                                ...
                                <select name="id_rute_kapal" class="form-control">
                                        ...
                                        if (mysqli_num_rows($result) > 0){
                                            while($row = mysqli_fetch_assoc($result)) {
                                                if($item["id_rute_kapal"] === $row["id_rute_kapal"]) {
                                                    $coba = 'selected';
                                                }
                                                else {
                                                    $coba = '';
                                                ...
                                                echo "
                                                <option value='".$row['id_rute_kapal']."' ".$coba.">".$row['pelabuhan1']." - ".$row['pelabuhan2']."</option>  
                                                ";
                                            }
                                        }
                                        mysqli_close($con); 
                            ...
                            <div class="form-group row mt-5">
                                <div class="col-md-6">
                                    <a name="backBtn" id="backBtn" class="btn btn-dark btn-block" href="../display/displayPelayaran.php" role="button">Kembali</a>
                                </div>
                                <div class="col-md-6">
