...
$query = "SELECT * FROM penerbangan WHERE id_penerbangan = $id_penerbangan";
    ...
    <div class="page-container">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="#" aria-expanded="true">Pesawat</a>
                                        <ul class="collapse">
                                            ...
                                            <li class="active"><a href="../display/displayPenerbangan.php">Penerbangan</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">Edit Data Penerbangan</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionEditPenerbangan.php" method="POST">

                            <input type="hidden" name="id_penerbangan" value="<?php echo $item["id_penerbangan"] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT * FROM maskapai WHERE deleted=0";
                                        $result = mysqli_query($con, $query);
                                        $coba = '';

                                        if (mysqli_num_rows($result) > 0) {
                                            while($row = mysqli_fetch_assoc($result)) {
                                                if($item["id_maskapai"] === $row["id_maskapai"]) {
                                                    $coba = 'selected';
                                                }
                                                else {
                                                    $coba = '';
                                                ...
                                                echo "
                                                <option value='".$row['id_maskapai']."' ".$coba.">".$row['nama_maskapai']."</option>  
                                                ";
                                            }
                                        }
                                        ?>
                            ...
                            <div class="form-group row mt-5">
                                <div class="col-md-6">
                                    <a name="backBtn" id="backBtn" class="btn btn-dark btn-block" href="../display/displayPenerbangan.php" role="button">Kembali</a>
                                </div>
                                <div class="col-md-6">
