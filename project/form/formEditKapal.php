...
$query = "SELECT * FROM kapal WHERE id_kapal = $id_kapal";
    ...
    <div class="page-container">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="#" aria-expanded="true">Kapal</a>
                                        <ul class="collapse">
                                            <li class="active"><a href="../display/displayKapal.php">Kapal</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">Edit Data Kapal</h2>
                <div class="row mt-5">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <form action="../process/actionEditKapal.php" method="POST">

                            <input type="hidden" name="id_kapal" value="<?php echo $item["id_kapal"] ?>">
                            
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Kapal</label>
                                <div class="col-md-9">
                                    <input type="text" name="nama_kapal" id="nama_kapal" class="form-control" placeholder="Nama kapal" required 
                                    value="<?php echo $item["nama_kapal"] ?>">
                                </div>
                            </div>
                            <div class="form-group row mt-5">
                                <div class="col-md-4">
                                    <a name="backBtn" id="backBtn" class="btn btn-dark btn-block" href="../display/displayKapal.php" role="button">Kembali</a>
                                </div>
                                <div class="col-md-4">
...
<html>
    ...
    <?php include '../navigation2.php' ?>
        <div class="container">
            <h2 class="mt-3 text-center">Edit Data Maskapai</h2>
            <div class="row mt-5">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <form action="../process/actionEditMaskapai.php" method="POST">

                        <input type="hidden" name="id_maskapai" value="<?php echo $item["id_maskapai"] ?>">
                        
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">Maskapai</label>
                            <div class="col-md-9">
                                <input type="text" name="nama_maskapai" id="nama_maskapai" class="form-control" placeholder="Nama Maskapai" required 
                                value="<?php echo $item["nama_maskapai"] ?>">
                            </div>
                        </div>
                        <div class="form-group row mt-5">
                            <div class="col-md-4">
