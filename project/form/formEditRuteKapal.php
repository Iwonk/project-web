...
$query = "SELECT * FROM rute_kapal WHERE id_rute_kapal = $id_rute_kapal";
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="#" aria-expanded="true">Kapal</a>
                                        <ul class="collapse">
                                            ...
                                            <li class="active"><a href="../display/displayRuteKapal.php">Rute</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-8">
                        <form action="../process/actionEditRuteKapal.php" method="POST">

                            <input type="hidden" name="id_rute_kapal" value="<?php echo $item["id_rute_kapal"] ?>">
