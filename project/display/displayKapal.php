                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="#" aria-expanded="true">Kapal</a>
                                        <ul class="collapse">
                                            <li class="active"><a href="displayKapal.php">Kapal</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                <!-- MAIN CONTENT GOES HERE -->
                    <h2 class="mt-3 text-center">KAPAL</h2>
                    <?php
                    $message = '';
                    if(isset($_GET["error"])) {
                        $message = $_GET["error"];
                    ...
                    ?>
                    <a href="../form/formAddKapal.php" class="btn btn-success mt-3">Tambah Data Kapal</a>
                    <div class="row">
                        <table id="data" class="table table-stripped text-center mt-3">
                            ...
                            <tbody>
                            <?php
                            $query = "SELECT * FROM kapal WHERE deleted=0 ORDER BY id_kapal";
                            ...
                            if (mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href='../form/formEditKapal.php?id_kapal=$id_kapal' class='btn btn-warning'>Update</a>
                                            <a href='../process/actionDeleteKapal.php?id_kapal=$id_kapal' class='btn btn-danger'>Delete</a>
                                        </td>
                                    </tr>
                                    ";
                                }
