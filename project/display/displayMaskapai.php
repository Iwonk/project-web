                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="#" aria-expanded="true">Pesawat</a>
                                        <ul class="collapse">
                                            <li class="active"><a href="displayMaskapai.php">Maskapai</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                <!-- MAIN CONTENT GOES HERE -->
                    <h2 class="mt-3 text-center">MASKAPAI</h2>
                    <?php
                    $message = '';
                    if(isset($_GET["error"])) {
                        $message = $_GET["error"];
                    ...
                    ?>
                    <a href="../form/formAddMaskapai.php" class="btn btn-success mt-3">Tambah Data Maskapai</a>
                    <div class="row">
                        <table id="data" class="table table-stripped text-center mt-3">
                            ...
                            <tbody>
                            <?php
                            $query = "SELECT * FROM maskapai WHERE deleted=0 ORDER BY id_maskapai";
                            ...
                            if (mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo "
                                    <tr>
                                        <input type='hidden' name='id_maskapai' value='".$id_maskapai."'>
                                        <td>" .$row["id_maskapai"]. "</td>
                                        <td>" .$row["nama_maskapai"]. "</td>
                                        <td>
                                            <a href='../form/formEditMaskapai.php?id_maskapai=$id_maskapai' class='btn btn-warning'>Update</a>
                                            <a href='../process/actionDeleteMaskapai.php?id_maskapai=$id_maskapai' class='btn btn-danger'>Delete</a>
                                        </td>
                                    </tr>
                                    ";
                                }
