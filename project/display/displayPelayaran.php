    ...
    <div class="page-container">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="#" aria-expanded="true">Kapal</a>
                                        <ul class="collapse">
                                            ...
                                            <li class="active"><a href="displayPelayaran.php">Pelayaran</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">PELAYARAN</h2>
                <?php
                $message = '';
                if(isset($_GET["error"])) {
                    $message = $_GET["error"];
                ...
                ?>
                <a href="../form/formAddPelayaran.php" class="btn btn-success mt-3">Tambah Data Pelayaran</a>
                <div class="row">
