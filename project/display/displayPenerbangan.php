    ...
    <div class="page-container">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="#" aria-expanded="true">Pesawat</a>
                                        <ul class="collapse">
                                            ...
                                            <li class="active"><a href="displayPenerbangan.php">Penerbangan</a></li>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <h2 class="mt-3 text-center">PENERBANGAN</h2>
                <?php
                $message = '';
                if(isset($_GET["error"])) {
                    $message = $_GET["error"];
                ...
                ?>
                <a href="../form/formAddPenerbangan.php" class="btn btn-success mt-3">Tambah Data Penerbangan</a>
                <div class="row">
                    <table id="data" class="table table-stripped text-center mt-3">
                        ...
                        <tbody>
                        <?php
                        $query = "SELECT p.id_penerbangan, m.nama_maskapai, k1.kota1, k2.kota2 FROM penerbangan p,maskapai m, rute r, kota1 k1, kota2 k2
                        WHERE p.id_maskapai = m.id_maskapai AND
                        p.id_rute = r.id_rute AND
                        r.kota1 = k1.id_kota1 AND
                        r.kota2 = k2.id_kota2 AND
                        p.deleted = 0
                        ORDER BY m.nama_maskapai";

                        $result = mysqli_query($con, $query);
                        if (mysqli_num_rows($result) > 0){
                            while($row = mysqli_fetch_assoc($result)){
                                $id_penerbangan = $row["id_penerbangan"];
                                echo "
                                <tr>
                                    ...
                                    <td>
                                        <a href='../form/formEditPenerbangan.php?id_penerbangan=$id_penerbangan' class='btn btn-warning'>Update</a>
                                        <a href='../process/actionDeletePenerbangan.php?id_penerbangan=$id_penerbangan' class='btn btn-danger'>Delete</a>
                                    </td>
                                </tr>
                                ";
                            }
