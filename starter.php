                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="#" aria-expanded="true">Kapal</a>
                                        <ul class="collapse">
                                            <li><a href="project/display/displayKapal.php">Kapal</a></li>
                                            <li><a href="project/display/displayRuteKapal.php">Rute</a></li>
                                            <li><a href="project/display/displayPelayaran.php">Pelayaran</a></li>
                                            <li><a href="project/display/displayDataPelayaran.php">Data</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
